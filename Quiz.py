...
def dsa():
    ans = 0
    a = [
        ["Que1. What is the full form of DSA?", "1. Data Structure and Algorithm", "2. Data Science Algorithm", "3. Data Sort Algorithm", "4. Domain Search Algorithm", 1],
        ["Que2. What is the average time complexity of searching for an element in a balanced binary search tree (BST)?", "1. O(1)", "2. O(log n)", "3. O(n)", "4. O(n log n)", 2],
        ["Que3. Which data structure uses LIFO (Last In First Out) principle?", "1. Queue", "2. Stack", "3. Array", "4. Linked List", 2],
    ...
    for i in range(len(a)):
        ...
        while True:
            try:
                ans1 = int(input("Enter your answer (1-4): "))
                if ans1 in range(1, 5):
                    break
                else:
...
def dbms():
    ...
    ans = 0
    a = [
        ["Que1. Which of the following is a primary key?", "1. A unique identifier for each record in a table", "2. A key that can accept null values", "3. A key that is used to create relationships between tables", "4. A key that allows duplicate values", 1],
...
def python():
    ...
    ans = 0
    a = [
        ["Que1. Which of the following is a mutable data type in Python?", "1. Tuple", "2. List", "3. String", "4. Integer", 2],
...
def answ():
    print("Do you want to see the answers? Enter 1 for Yes or 0 for No.")
    while True:
        try:
    ...
    if m != name:
        ...
        while not n:
            ...
            if k != password:
                ...
                print("1. Each section contains 5 questions carrying 1 mark for each correct answer.")
                print("2. To clear the quiz you have to score a minimum of 6 marks.")
                print("3. Read all questions carefully and enter your answer.")
                print("4. All the best for the quiz")
                print("\n\n")
                print("Section 1: DSA\n")
                ...
                if marks < 6:
                    print(f"You failed the quiz with marks: {marks}")
